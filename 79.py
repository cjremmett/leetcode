...
class Solution:
    def exist(self, board: List[List[str]], word: str) -> bool:
        ...
        for tup in self.positions_dict[word[0]]:
            ...
            result = self.next_letter_iteration(tup, word, 1, already_seen)
            if result == True:
                return True
...
if __name__ == '__main__':
    test_cases = ( ([["a","a"]], 'aaa', False), ([["A","B","C","E"],["S","F","C","S"],["A","D","E","E"]], 'ABCB', False), ([["A","B","C","E"],["S","F","C","S"],["A","D","E","E"]], 'ABCCED', True), ([["A","B","C","E"],["S","F","C","S"],["A","D","E","E"]], 'SEE', True))
